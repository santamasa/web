...
const validators = {
  ...
  REACT_APP_FEATURE_FOX_PAGE: bool({ default: true }),
  REACT_APP_FEATURE_FOX_PAGE_RFOX: bool({ default: true }),
  REACT_APP_FEATURE_FOX_PAGE_FOX_SECTION: bool({ default: true }),
  REACT_APP_FEATURE_FOX_PAGE_FOX_FARMING_SECTION: bool({ default: true }),
  REACT_APP_FEATURE_FOX_PAGE_GOVERNANCE: bool({ default: true }),
